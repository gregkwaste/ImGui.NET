...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiLastItemDataBackupPtr
    {
        ...
        public static implicit operator ImGuiLastItemDataBackupPtr(ImGuiLastItemDataBackup* nativePtr) => new ImGuiLastItemDataBackupPtr(nativePtr);
        public static implicit operator ImGuiLastItemDataBackup* (ImGuiLastItemDataBackupPtr wrappedPtr) => wrappedPtr.NativePtr;
        public static implicit operator ImGuiLastItemDataBackupPtr(IntPtr nativePtr) => new ImGuiLastItemDataBackupPtr(nativePtr);
        ...
        public void Backup()
        {
            ImGuiNative.ImGuiLastItemDataBackup_Backup((ImGuiLastItemDataBackup*)(NativePtr));
        }
        public void Destroy()
        {
            ImGuiNative.ImGuiLastItemDataBackup_destroy((ImGuiLastItemDataBackup*)(NativePtr));
        }
        public void Restore()
        {
            ImGuiNative.ImGuiLastItemDataBackup_Restore((ImGuiLastItemDataBackup*)(NativePtr));
        }
    }
}
