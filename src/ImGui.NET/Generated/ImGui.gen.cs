...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        public static void ErrorCheckEndFrameRecover(ImGuiErrorLogCallback log_callback)
        {
            void* user_data = null;
            ImGuiNative.igErrorCheckEndFrameRecover(log_callback, user_data);
        }
        public static void ErrorCheckEndFrameRecover(ImGuiErrorLogCallback log_callback, IntPtr user_data)
        {
        ...
        public static Vector2 FindBestWindowPosForPopupEx(Vector2 ref_pos, Vector2 size, ImGuiDirPtr last_dir, ImRect r_outer, ImRect r_avoid, ImGuiPopupPositionPolicy policy)
        {
            Vector2 __retval;
            ImGuiDir* native_last_dir = last_dir.NativePtr;
        ...
        public static string ImTextCharToUtf8(out sbyte out_buf, uint c)
        {
            fixed (sbyte* native_out_buf = &out_buf)
            {
